...
public class HttpClientDownloader extends AbstractDownloader {
    ...
    public Page download(Request request, Task task) {
        ...
        try {
            ...
            httpResponse = httpClient.execute(requestContext.getHttpUriRequest(), context);
            ...
            if (proxyProvider != null && proxy != null) proxyProvider.destroy(proxy);
            logger.warn("Connect Url: {} error", request.getUrl(), e);
